...
// Generated 2016/6/16 ¤U¤È 03:38:47 by Hibernate Tools 3.4.0.CR1
...
/**
 * Home object for domain model class Control.
 * @see .Control
 * @author Hibernate Tools
 */
public class ControlHome {

	private static final Log log = LogFactory.getLog(ControlHome.class);
	...
	public void persist(Control transientInstance) {
		log.debug("persisting Control instance");
		try {
	...
	public Control merge(Control detachedInstance) {
		...
		try {
			Control result = (Control) sessionFactory.getCurrentSession()
	...
	public Control findById(long id) {
		...
		try {
			Control instance = (Control) sessionFactory.getCurrentSession()
					.get("Control", id);
			if (instance == null) {
	...
	public List findByExample(Control instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("Control").add(Example.create(instance))
					.list();
